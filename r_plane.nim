...
var
    ...
    ceilingfunc {.exportc.}: planefunction_t
    visplanes {.exportc.}: array[MAXVISPLANES, visplane_t]
    lastvisplane {.exportc.}: ptr visplane_t
    floorplane {.importc, header:"r_state.h".}: ptr visplane_t
    ceilingplane {.importc, header:"r_state.h".}: ptr visplane_t
    openings {.exportc.}: array[MAXOPENINGS, cshort]
    lastopening {.exportc.}: ptr cshort
    floorclip {.exportc.}: array[SCREENWIDTH, cshort]
    ceilingclip {.exportc.}: array[SCREENWIDTH, cshort]
    spanstart {.exportc.}: array[SCREENHEIGHT, cshort]
    spanstop {.exportc.}: array[SCREENHEIGHT, cshort]
    planezlight {.exportc.}: ptr ptr lighttable_t
    planeheight {.exportc.}: fixed_t
    yslope {.exportc.}: array[SCREENHEIGHT, fixed_t]
    distscale {.exportc.}: array[SCREENWIDTH, fixed_t]
    basexscale {.exportc.}: fixed_t
    baseyscale {.exportc.}: fixed_t
    cachedheight {.exportc.}: array[SCREENHEIGHT, fixed_t]
